        ...
        <div class="rounded-lg sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center">
          ...
          <form class="text-center" onSubmit={formik.handleSubmit}>
            ...
            <div class="py-2">
              <button
                type="submit"
                class="border-2 border-gray-100 focus:outline-none bg-pink-600 text-white font-bold tracking-wider block w-full p-2 rounded-lg focus:border-gray-700 hover:bg-pink-700"
              >
                Login
              </button>
            </div>
          ...
          <div class="text-center">
            <a href="/adminforgotpassword" class="hover:underline">
              Forgot password?
            </a>
          </div>
          <div class="text-center mt-12">
            ...
            <a
              href="/adminregister"
              class="text-md text-pink-600 underline font-light hover:font-semibold hover:text-pink-800"
            >
              Create One
            </a>
          </div>
